...
<a href="<?=get_the_permalink(40) . 'industry/' . $industry->term_id ?>"
    data-term-id="<?=$industry->term_id ?>"
    class="btn btn--grey btn--small our-work__industry <?= in_array($industry->term_id, $selectedCategories) ? 'active' : '' ?>">
    <?= $industry->name ?>
</a>
<?php endforeach; ?>
