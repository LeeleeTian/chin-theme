...
class TrueFaq
{
    ...
    /* -------------------------------------------------- */
    private static $postType = 'true_faq';
    private static $singleName = 'Faq';
    private static $pluralName = 'Faqs';
    private static $slug = 'faq';
    private static $templateName = 'single-faq';
    private static $menuImage = 'trueCogWPIcons';

    //Taxonomy Details
    public static $hasTax = true;
    public static $taxName = 'true_faq_tax';
    public static $taxSlug = 'faq-categories';
