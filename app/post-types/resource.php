...
class TrueResource
{
    ...
    /* -------------------------------------------------- */
    private static $postType = 'true_resource';
    private static $singleName = 'Resource';
    private static $pluralName = 'Resources';
    private static $slug = 'resource';
    private static $templateName = 'single-resource';
    private static $menuImage = 'trueCogWPIcons';

    //Taxonomy Details
    public static $hasTax = true;
    public static $taxName = 'true_resource_tax';
    public static $taxSlug = 'resource-categories';
