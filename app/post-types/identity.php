...
class TrueIdentity
{
    ...
    /* -------------------------------------------------- */
    private static $postType = 'true_identity';
    private static $singleName = 'Identity';
    private static $pluralName = 'Identities';
    private static $slug = 'identity';
    private static $templateName = 'single-identity';
    private static $menuImage = 'trueCogWPIcons';

    //Taxonomy Details
    public static $hasTax = false;
    public static $taxName = 'true_identity_tax';
    public static $taxSlug = 'identities';
